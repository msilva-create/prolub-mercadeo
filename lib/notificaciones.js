...
const COMERCIALES = {
  ...
  'inversiones-ob':  ['cblanco@prolub.com.co', 'grodriguez@prolub.com.co'],
  'lubricartagena':  'oramirez@prolub.com.co',
...
export default async function handler(req, res) {
  ...
  const comercial = COMERCIALES[distribuidor_id] || 'msilva@prolub.com.co'
  const comerciales = Array.isArray(comercial) ? comercial : [comercial]
  
  const destinatarios = ['msilva@prolub.com.co', 'cgil@prolub.com.co', ...comerciales]
