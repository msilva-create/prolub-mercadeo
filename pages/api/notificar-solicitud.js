          ...
          <table cellpadding="0" cellspacing="0" style="padding:24px 36px;">
            <tr>
              ...
              <td style="padding-left:14px;">
                ...
                <p style="margin:2px 0 0;color:rgba(255,255,255,0.6);font-size:12px;">Fondo de Mercadeo · Nueva Solicitud</p>
              </td>
            </tr>
          </table>
        </td>
...
`.trim()
  ...
  try {
    await transporter.sendMail({
      ...
      subject: `[Prolub Mercadeo] Nueva solicitud — ${distribuidor_nombre} · ${tipo_actividad}`,
      text: textoPlano,
      html: htmlBody,
    })
